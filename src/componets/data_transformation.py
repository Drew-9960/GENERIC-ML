...
class DataTransformation:
        ...
        try:
            ...
            cat_pipeline = Pipeline(
                steps=[
                    ...
                    ("scaler", StandardScaler(with_mean=False)),  # Avoid errors with sparse matrix
                ]
            )

            logging.info("Numerical columns standard scalar completed")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            logging.info("Column name standardization completed")
